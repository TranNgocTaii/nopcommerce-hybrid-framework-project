...
public class UserSortDisplayPagingTest extends BaseTest {
    ...
    public void beforeClass(String browserName, String environmentName) {
        ...
        userHomePage.hoverMoveToTopMenu(driver, "Computers");

        userHomePage.clickToSecondMenuInTopMenu(driver, "Computers", "Notebooks");
    }
    ...
    public void TC_24_Sort_With_Name_A_To_Z(Method method){
        ...
        userHomePage.selectToDropDownByName(driver, "products-orderby", "Name: A to Z");
        ...
        Assert.assertTrue(userHomePage.isProductNameSortByAscending(driver));
    }
    ...
    public void TC_25_Sort_With_Name_Z_To_A(Method method){
        ...
        userHomePage.selectToDropDownByName(driver, "products-orderby", "Name: Z to A");
        userHomePage.sleepInSecond(3);

        ExtentTestManager.getTest().log(Status.INFO,"Search - Step 02: Verify that the product name is sort by descending");
        Assert.assertTrue(userHomePage.isProductNameSortByDescending(driver));
    }
    ...
    public void TC_26_Sort_With_Price_Low_To_High(Method method){
        ...
        userHomePage.selectToDropDownByName(driver, "products-orderby", "Price: Low to High");
        userHomePage.sleepInSecond(3);

        ExtentTestManager.getTest().log(Status.INFO,"Search - Step 02: Verify that the product price is sort by ascending");
        Assert.assertTrue(userHomePage.isProductPriceSortByAscending(driver));
    }
    ...
    public void TC_27_Sort_With_Price_High_To_Low(Method method){
        ...
        userHomePage.selectToDropDownByName(driver, "products-orderby", "Price: High to Low");
        userHomePage.sleepInSecond(3);

        ExtentTestManager.getTest().log(Status.INFO,"Search - Step 02: Verify that the product price is sort by descending");
        Assert.assertTrue(userHomePage.isProductPriceSortByDescending(driver));
    }
    ...
    public void TC_28_Display_With_3_Product(Method method){
        ...
        userHomePage.selectToDropDownByName(driver, "products-pagesize", "3");
        userHomePage.sleepInSecond(3);
        ...
        Assert.assertTrue(userHomePage.isProductNumberLessThanOrEqualDisplayed(driver, 3));
    ...
    public void TC_29_Display_With_6_Product(Method method){
        ...
        userHomePage.selectToDropDownByName(driver, "products-pagesize", "6");
        userHomePage.sleepInSecond(3);
        ...
        Assert.assertTrue(userHomePage.isProductNumberLessThanOrEqualDisplayed(driver, 6));
    ...
    public void TC_30_Display_With_9_Product(Method method){
        ...
        userHomePage.selectToDropDownByName(driver, "products-pagesize", "9");
        userHomePage.sleepInSecond(3);
        ...
        Assert.assertTrue(userHomePage.isProductNumberLessThanOrEqualDisplayed(driver, 9));
